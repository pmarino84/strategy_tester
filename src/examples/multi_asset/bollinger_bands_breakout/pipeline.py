...
def create_strategy(context: Context):
  class ForexSqueezeBreakoutStrategy(Strategy):
    ...
    def init(self):
      ...
      bbands = ta.bbands(self.data["Close"].s, length=self.bb_period, std=self.bb_multiplier)
    ...
    def next(self):
      ...
      if len(self.trades) == 0:
        ...
        go_long = bb_long_signal
        go_short = bb_short_signal
  ...
  return create_optimization_pipeline_with_metrics(
    {
      ...
      # "bb_multiplier": [i/10 for i in range(13, 22)],
    },
